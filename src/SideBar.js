function SideBar() {
  return(
    <div className="sidebar md:col-span-3 space-y-6 py-7 px-2 absolute inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition duration-200 ease-in-out border-2 border-black">
      <nav>
